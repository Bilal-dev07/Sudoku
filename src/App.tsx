...
function App() {
  ...
  return (
    <div className="pt-12 dark:bg-gray-800">
      <h1 className="text-center font-black text-3xl text-gray-800 dark:text-gray-50">
        <Darkmode /> Sudoku
      </h1>
      <p className="text-center px-4 lg:px-0 text-gray-500 w-full lg:w-[820px] mx-auto text-xs mt-1">
        Please be aware that this solver may not always solve the Sudoku, as it
        uses{' '}
        <a
      ...
      <section className="w-full px-4 lg:px-0 lg:w-[880px] mx-auto mt-4">
          ...
          state.notSolved ? (
            <p className="mt-4 bg-gray-100 py-2 rounded-sm text-gray-500 dark:bg-gray-900 flex gap-1 justify-center px-4">
              ...
              <span className="text-xs self-center">
                Sudoku board may be invalid or there's is something wrong with
                my parameters.
              </span>
            </p>
          ) : state.solved ? (
      ...
      <footer className="py-4 mt-12">
        <p className="text-center text-gray-800 dark:text-gray-300 text-xs">
          Made with <span className="text-red-500 dark:text-red-600">❤️</span>{' '}
          by Bilal -{' '}
          <a
            href="https://github.com/Bilal-dev07/Sudoku.git"
            target="_blank"
            className="bg-gray-800 px-2 py-1 text-gray-50 rounded-sm dark:bg-gray-900 hover:bg-gray-700 cursor-pointer dark:hover:bg-gray-950 transition"
          >
            ⭐ Star me on Github
          </a>
        </p>
